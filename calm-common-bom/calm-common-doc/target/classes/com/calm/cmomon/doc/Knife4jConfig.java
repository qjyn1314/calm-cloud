...
public class Knife4jConfig {
    ...
    private static final String[] PACKAGED_TO_MATCH = {"com.calm.sequence.persistence.controller","com.calm.user.persistence.controller","com.calm.user.provider"};
