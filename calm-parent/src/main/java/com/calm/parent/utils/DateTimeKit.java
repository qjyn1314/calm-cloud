...
public class DateTimeKit {
     ...
     * 短日期格式
     */
    public final static String SHORT_DATE_PATTERN = "yyyy-MM";
    /**
     * 标准日期格式
     */
     ...
     * 标准日期（不含时间）格式化器
     */
    private static final ThreadLocal<SimpleDateFormat> SHORT_DATE_FORMAT = new ThreadLocal<SimpleDateFormat>() {
        @Override
     ...
     * 标准日期（不含时间）格式化器
     */
    private static final ThreadLocal<SimpleDateFormat> NORM_DATE_FORMAT = new ThreadLocal<SimpleDateFormat>() {
        @Override
        synchronized protected SimpleDateFormat initialValue() {
     ...
     * 标准时间格式化器
     */
    private static final ThreadLocal<SimpleDateFormat> NORM_TIME_FORMAT = new ThreadLocal<SimpleDateFormat>() {
        @Override
        synchronized protected SimpleDateFormat initialValue() {
     ...
     * 标准日期时间格式化器
     */
    private static final ThreadLocal<SimpleDateFormat> NORM_DATETIME_FORMAT = new ThreadLocal<SimpleDateFormat>() {
        @Override
        synchronized protected SimpleDateFormat initialValue() {
     ...
     * HTTP日期时间格式化器
     */
    private static final ThreadLocal<SimpleDateFormat> HTTP_DATETIME_FORMAT = new ThreadLocal<SimpleDateFormat>() {
        @Override
        synchronized protected SimpleDateFormat initialValue() {
     ...
     * @return
     */
    public static Date lastDateOfLastWeek(Date date) {
        int nowOfWeek = localDayOfWeek(date);
        return offsiteDay(date, -nowOfWeek).toDate();
    }
    ...
    public static Date lastDateOfWeek(Date date) {
        ...
        return offsiteDay(date, 7 - nowOfWeek).toDate();
    }
     ...
     * @return
     */
    public static int localDayOfWeek(Date date) {
        final Calendar cal = Calendar.getInstance();
        cal.setTime(date);

        final int dayOfWeek = cal.get(Calendar.DAY_OF_WEEK);
        return localDayOfWeek(dayOfWeek);
    }

    /**
     * 本地化周几（周日是7，周一是1）
     *
     * @param dayOfWeek 原生星期索引（周日是1，周六是7）
     * @return
     */
    public static int localDayOfWeek(int dayOfWeek) {
     ...
     * @return
     */
    public static String localDayNameOfWeekFromInternationalDayOfWeek(Date date) {
        return localDayNameOfWeekFromLocalDayOfWeek(localDayOfWeek(date));
    }

    /**
     * 本地化周几（周日，周一）
     *
     * @param dayOfWeek 国际标准星期索引（周日是1，周六是7）
     * @return
     */
    public static String localDayNameOfWeekFromInternationalDayOfWeek(int dayOfWeek) {
        return localDayNameOfWeekFromLocalDayOfWeek(localDayOfWeek(dayOfWeek));
    }

    /**
     * 本地化周几（周日，周一）
     *
     * @param localDayOfWeek 本地化星期索引（周日是7，周一是1）
     * @return
     */
    public static String localDayNameOfWeekFromLocalDayOfWeek(int localDayOfWeek) {
    ...
    public static boolean isLeapYear(Date date) {
        return convert(date).isLeapYear();
    }

    public static void main(String[] args) {
        System.out.println("当前日期是周几：" + localDayOfWeek(new Date()));
        System.out.println("当前日期是几号：" + dayOfMonth(new Date()));
        System.out.println("当前月第一天：" + firstDayOfMonth(new Date()));
        System.out.println("当前月第一天是几号：" + dayOfMonth(firstDayOfMonth(new Date())));
        System.out.println("当前月最后一天：" + lastDayOfMonth(new Date()));
        System.out.println("当前月最后一天是几号：" + dayOfMonth(lastDayOfMonth(new Date())));
        System.out.println("当前月几月：" + month(new Date()));
        System.out.println("LocalDate：" + convert(new Date()));
        System.out.println("当前年是否是润年：" + isLeapYear(new Date()));
        System.out.println("上月最后一天：" + lastDayOfLastMonth(new Date()));
        System.out.println("设置月10号：" + setDayOfMonth(new Date(), 10));
        System.out.println("上周日：" + lastDateOfLastWeek(new Date()));
    }
     ...
     * @return
     */
    public static LocalDate dayOfNextWeek(int weekOfNow) {
        return dayOfThisWeek(weekOfNow).plusWeeks(1);
    }
     ...
     * @return
     */
    public static LocalDate dayOfLastWeek(int weekOfNow) {
        return dayOfThisWeek(weekOfNow).minusWeeks(1);
    }
     ...
     * @return
     */
    public static LocalDate dayOfThisWeek(int weekOfNow) {
        return LocalDate.now().with(DayOfWeek.of(weekOfNow));
    }
